...
# Algorithm: ippo    Default checkpoint: red_checkpoints/ppo/ippo/best
...
RED_POLICY_DIR="${RED_POLICY_DIR:-red_checkpoints/ppo/ippo/${RED_POLICY_TAG}}"
EPISODES="${EPISODES:-100}"
OUTPUT_DIR="${OUTPUT_DIR:-evaluation_output/red_ppo_ippo_${RED_POLICY_TAG}}"
